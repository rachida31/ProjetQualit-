...
package project.coheance_detection_0_1;
...
/**
 * Job: Coheance_detection Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Coheance_detection implements TalendJob {
	...
	private final String jobName = "Coheance_detection";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Coheance_detection.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Coheance_detection.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		final static byte[] commonByteArrayLock_PROJECT_Coheance_detection = new byte[0];
		static byte[] commonByteArray_PROJECT_Coheance_detection = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJECT_Coheance_detection.length) {
					if (length < 1024 && commonByteArray_PROJECT_Coheance_detection.length == 0) {
						commonByteArray_PROJECT_Coheance_detection = new byte[1024];
					} else {
						commonByteArray_PROJECT_Coheance_detection = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJECT_Coheance_detection, 0, length);
				strReturn = new String(commonByteArray_PROJECT_Coheance_detection, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJECT_Coheance_detection) {
				...
				try {
					...
					this.countTotal = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.countTotal, dos);
		...
		public String toString() {
			...
			sb.append(",countTotal=" + String.valueOf(countTotal));
			sb.append("]");
	...
	public static class OnRowsEndStructtAggregateRow_3
		...
		public void copyDataTo(OnRowsEndStructtAggregateRow_3 other) {
			...
			other.age = this.age;
			other.countTotal = this.countTotal;
...
// Start of branch "row1"
						if (row1 != null) {
							...
							operation_result_tAggregateRow_3.countTotal_clmCount++;
				...
				// source node:tAggregateRow_3_AGGIN - inputs:(OnRowsEnd) outputs:(row4,row4) |
				...
				for (AggOperationStruct_tAggregateRow_3 aggregated_row_tAggregateRow_3 : values_tAggregateRow_3) { // G_AggR_600
					...
					row4.countTotal = (int) aggregated_row_tAggregateRow_3.count;
					row4.countTotal = (int) aggregated_row_tAggregateRow_3.countTotal_clmCount;
					...
					row4_HashRow.nconst = row4.nconst;

					row4_HashRow.primaryName = row4.primaryName;

					row4_HashRow.Email = row4.Email;

					row4_HashRow.birthYear = row4.birthYear;

					row4_HashRow.deathYear = row4.deathYear;

					row4_HashRow.primaryProfession = row4.primaryProfession;

					row4_HashRow.knownForTitles = row4.knownForTitles;

					row4_HashRow.age = row4.age;

					row4_HashRow.countTotal = row4.countTotal;
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		...
		public Integer countIncoherant;

		public Integer getCountIncoherant() {
			return this.countIncoherant;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJECT_Coheance_detection) {
				...
				try {
					...
					this.countIncoherant = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.countIncoherant, dos);
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("countIncoherant=" + String.valueOf(countIncoherant));
			sb.append(",countTotal=" + String.valueOf(countTotal));
			sb.append("]");
	...
	public static class OnRowsEndStructtAggregateRow_1
		...
		public void copyDataTo(OnRowsEndStructtAggregateRow_1 other) {
			...
			other.knownForTitles = this.knownForTitles;
			other.age = this.age;
			other.countIncoherant = this.countIncoherant;
...
// ------------
				...
				class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
					...
					public boolean hashCodeDirty = true;
					int count = 0;
					int countIncoherant_clmCount = 0;
				...
				Object filename_tFileInputDelimited_2 = /** Start field tFileInputDelimited_2:FILENAME */
						"C:/Users/lylia/Desktop/Dataset/Acturs.csv"/** End field tFileInputDelimited_2:FILENAME */
				;
					...
					while (limittFileInputDelimited_2 != 0 && csvReadertFileInputDelimited_2 != null
						...
						try {
							...
							if (rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])) {// empty
								...
								row5.primaryProfession = null;

								row5.knownForTitles = null;
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row5.nconst = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row5.primaryName = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									if (rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row5.birthYear = ParserUtils.parseTo_Integer(
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row5.deathYear = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row5.primaryProfession = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row5.knownForTitles = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									if (rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row5.age = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
...
// replace the following expression by your own filter condition 
							...
							!(((Integer.parseInt(TalendDate.formatDate("yyyy", TalendDate.getCurrentDate()))
									- row5.birthYear) == row5.age))), "advanced condition failed");

							if (ope_tFilterRow_1.getMatchFlag()) {
								if (row2 == null) {
									row2 = new row2Struct();
								}
								row2.nconst = row5.nconst;
								row2.primaryName = row5.primaryName;
								row2.Email = row5.Email;
								row2.birthYear = row5.birthYear;
								row2.deathYear = row5.deathYear;
								row2.primaryProfession = row5.primaryProfession;
								row2.knownForTitles = row5.knownForTitles;
								row2.age = row5.age;
...
// Start of branch "row2"
							if (row2 != null) {
								...
								if (row2.nconst != null) { // G_OutMain_AggR_546

									operation_result_tAggregateRow_1.countIncoherant_clmCount++;
				...
				String tableName_tDBOutput_1 = "deux_colonne";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:IEerTtLRO/+mzsmnVgbXuquzSr6K7zl9z5qcAg==");
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "deux_colonne"
						+ "` (`Id`,`Facteur_Qualite`,`Metrique`,`Niveau`,`Colonne1`,`Colonne2`,`Valeur`,`Date`) VALUES (?,?,?,?,?,?,?,?)";
...
// ###############################
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					row3.countIncoherant = (int) aggregated_row_tAggregateRow_1.count;
					row3.countIncoherant = (int) aggregated_row_tAggregateRow_1.countIncoherant_clmCount;
...
// # Output table : 'out1'
							out1_tmp.countIncoherant = row3.countIncoherant;
							out1_tmp.countTotal = row4.countTotal;
							out1 = out1_tmp;
// ###############################
...
// Start of branch "out1"
						if (out1 != null) {
							...
							if (out1.countTotal > 0) {

								row6.Facteur_Qualite = "Cohéance";
								row6.Niveau = "Table Acteur";
								row6.Colonne1 = "Age";
								row6.Colonne2 = "birthYear";
								row6.Metrique = "Pourcentage de valeurs non cohérentes";
								row6.Valeur = out1.countIncoherant.doubleValue() / out1.countTotal.doubleValue() * 100;
							...
							if (row6.Niveau == null) {
								...
								pstmt_tDBOutput_1.setString(4, row6.Niveau);
							}

							if (row6.Colonne1 == null) {
								pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(5, row6.Colonne1);
							}

							if (row6.Colonne2 == null) {
								pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(6, row6.Colonne2);
							}

							pstmt_tDBOutput_1.setDouble(7, row6.Valeur);

							if (row6.Date == null) {
								pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(8, row6.Date);
							}
...
// ###############################      
	...
	public static void main(String[] args) {
		final Coheance_detection Coheance_detectionClass = new Coheance_detection();

		int exitCode = Coheance_detectionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Coheance_detection.class.getClassLoader()
					.getResourceAsStream("project/coheance_detection_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Coheance_detection.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Coheance_detection");
		}
...
/************************************************************************************************
 * 175986 characters generated by Talend Open Studio for Data Integration on the
 * 16 décembre 2020 23:14:27 CET
 ************************************************************************************************/