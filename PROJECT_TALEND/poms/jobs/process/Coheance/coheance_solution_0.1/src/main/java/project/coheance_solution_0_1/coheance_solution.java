...
package project.coheance_solution_0_1;
...
/**
 * Job: coheance_solution Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class coheance_solution implements TalendJob {
	...
	private final String jobName = "coheance_solution";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					coheance_solution.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(coheance_solution.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_PROJECT_coheance_solution = new byte[0];
		static byte[] commonByteArray_PROJECT_coheance_solution = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJECT_coheance_solution.length) {
					if (length < 1024 && commonByteArray_PROJECT_coheance_solution.length == 0) {
						commonByteArray_PROJECT_coheance_solution = new byte[1024];
					} else {
						commonByteArray_PROJECT_coheance_solution = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJECT_coheance_solution, 0, length);
				strReturn = new String(commonByteArray_PROJECT_coheance_solution, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJECT_coheance_solution) {
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Users/lylia/Desktop/Dataset/outt.csv"))
						...
						try {
							...
							if (rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])) {// empty
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.nconst = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.primaryName = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.birthYear = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.deathYear = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.primaryProfession = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									row1.knownForTitles = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
// Start of branch "row1"
						if (row1 != null) {
							...
							row3.primaryProfession = row1.primaryProfession;
							row3.knownForTitles = row1.knownForTitles;
							row3.age = row1.age;

							if ((TalendDate.getPartOfDate("YEAR", TalendDate.getCurrentDate())
									- Integer.valueOf(row1.birthYear) != Integer.valueOf(row1.age))) {

								row3.age = (TalendDate.getPartOfDate("YEAR", TalendDate.getCurrentDate())
										- Integer.valueOf(row1.birthYear));
							}
...
//else {row3.age = 0;}
							...
							if (row3.nconst != null) {
								sb_tFileOutputDelimited_1.append(row3.nconst);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row3.primaryName != null) {
								sb_tFileOutputDelimited_1.append(row3.primaryName);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row3.Email != null) {
							...
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row3.birthYear != null) {
								sb_tFileOutputDelimited_1.append(row3.birthYear);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row3.deathYear != null) {
								sb_tFileOutputDelimited_1.append(row3.deathYear);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row3.primaryProfession != null) {
								sb_tFileOutputDelimited_1.append(row3.primaryProfession);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row3.knownForTitles != null) {
								sb_tFileOutputDelimited_1.append(row3.knownForTitles);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row3.age != null) {
	...
	public static void main(String[] args) {
		final coheance_solution coheance_solutionClass = new coheance_solution();

		int exitCode = coheance_solutionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = coheance_solution.class.getClassLoader()
					.getResourceAsStream("project/coheance_solution_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = coheance_solution.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : coheance_solution");
		}
...
/************************************************************************************************
 * 65305 characters generated by Talend Open Studio for Data Integration on the
 * 17 décembre 2020 00:47:28 CET
 ************************************************************************************************/